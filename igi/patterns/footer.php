	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:26%">
			<!-- wp:paragraph {"className":"igi-eyebrow"} --><p class="igi-eyebrow" style="margin-bottom:18px">Follow Us</p><!-- /wp:paragraph -->
				...
				<!-- /wp:html -->
			<!-- wp:html -->
				<p style="font-size:1rem;margin-bottom:14px"><a href="mailto:admin@innovativeglobalimpact.org" style="display:inline-flex;align-items:center;gap:8px;color:inherit;text-decoration:none;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="flex:0 0 auto;"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg><span>admin@innovativeglobalimpact.org</span></a></p>
				<!-- /wp:html -->
			<!-- wp:list {"style":{"typography":{"lineHeight":"2"}}} -->
			<ul class="wp-block-list" style="line-height:2">
